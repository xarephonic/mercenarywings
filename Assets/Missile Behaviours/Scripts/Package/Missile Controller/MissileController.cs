...
namespace MissileBehaviours.Controller
{
    ...
    public class MissileController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets the drag of the missiles rigidbody.
        /// </summary>
        public float Drag
        {
            get
        ...
        public Transform Target
        {
            ...
            {
                target = value;
                FireOnTargetChange(this, null);
            }
        }
        /// <summary>
        /// Gets os sets the current position of the active target. 
        /// The active target is the one the missile will prioritize. This can be used for course corrections or even waypoint systems.
        /// In order to use the normal target again, just set this to null.
        /// Please remember that neither the controller nor the guidance scripts ever change this value.
        /// So if you set this target, make sure to set it to null again once your conditions are met, otherwise the original target will never be hit.
        /// </summary>
        public Transform ActiveTarget
        {
            ...
            {
                activeTarget = value;
                FireOnActiveTargetChange(this, null);
            }
        }
        /// <summary>
        ...
        #endregion
        #region Events
        public event EventHandler OnTargetChange; // Fires an event whenever the target is changed via its property.
        public event EventHandler OnActiveTargetChange; // Fires an event whenever the active target is changed via its property. 
        #endregion
        ...
        internal void FireOnTargetChange(object sender, EventArgs e)
        {
            if (OnTargetChange != null)
                OnTargetChange(sender, e);
        }

        internal void FireOnActiveTargetChange (object sender, EventArgs e)
        {
            if (OnActiveTargetChange != null)
                OnActiveTargetChange(sender, e);
        }
    }
}