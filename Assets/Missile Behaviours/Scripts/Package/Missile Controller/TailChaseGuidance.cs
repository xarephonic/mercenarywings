    ...
    public class TailChaseGuidance : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (advancedMode)
            {
                ...
                currentDistance = Vector3.Distance(transform.position, activeTarget);
                if (currentDistance < previousDistance)
                {
                    ...
                    Vector3 los = (activeTarget - transform.position).normalized;
                ...
                {
                    controller.Rotate(Quaternion.LookRotation(activeTarget - transform.position, transform.up)); // Use the Rotate function of the controller, instead of the transforms, to consider the rotation rate of the missile.
                }
